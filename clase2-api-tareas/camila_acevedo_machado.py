...
router = APIRouter(prefix="/camila_acevedo_machado")
...
def saludo():
    ...
    return {"mensaje": "Hola, soy Camila Acevedo Machado"}
...
def doble(numero1: int,numero2: int):
    """Ejemplo: Endpoint que recibe un número en la ruta y devuelve su resultado."""
    return {"suma": numero1 * numero2}
