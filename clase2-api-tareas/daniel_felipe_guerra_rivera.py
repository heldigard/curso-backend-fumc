...
router = APIRouter(prefix="/daniel_felipe_guerra_rivera")

# Variable para usar en operaciones
mi_edad = 32
mi_animal_favorito = "aguila"  # Reto 1: Cambia "gato" por el nombre de tu animal favorito (ej: "perro")

@router.get("/saludo")
def saludo():
    """Reto 2: Endpoint de saludo personalizado. Cambia el mensaje a algo personal."""
    return {"mensaje": "Hola, mi nombre es Daniel Guerra"}
