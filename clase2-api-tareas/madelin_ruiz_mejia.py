...
router = APIRouter(prefix="/madelin_ruiz_mejia")

# Variable para usar en operaciones
mi_edad = 18
mi_animal_favorito = "mariposa"  # Reto 1: Cambia "gato" por el nombre de tu animal favorito (ej: "perro")

@router.get("/saludo a todo mi club de fans")
def saludo():
    """Reto 2: Endpoint de saludo personalizado. Cambia el mensaje a algo personal."""
    return {"mensaje": "Hola, soy Madelin Ruiz Mejía, la tralalerita"}
