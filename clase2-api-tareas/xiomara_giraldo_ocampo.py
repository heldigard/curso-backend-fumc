...
router = APIRouter(prefix="/xiomara_giraldo_ocampo")

# Variable para usar en operaciones
mi_edad = 30
mi_animal_favorito = "ballena"  # Reto 1: Cambia "gato" por el nombre de tu animal favorito (ej: "perro")

@router.get("/saludo")
def saludo():
    """Reto 2: Endpoint de saludo personalizado. Cambia el mensaje a algo personal."""
    return {"mensaje": "Hola, soy Xioma y me gusta mucho nadar"}
